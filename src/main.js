...
app.on('ready', () => {
  ...
  mainWindow.webContents.setUserAgent(
    mainWindow.webContents.getUserAgent() + ' TyranoErectron'
  );
  ...
  electron.ipcMain.handle('setFullScreen', () => {
    mainWindow.setFullScreen(true);
  });
  electron.ipcMain.handle('exitFullScreen', () => {
