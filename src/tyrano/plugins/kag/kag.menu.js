tyrano.plugin.kag.menu = {
            ...
            .click(function (e) {
              ...
              that.doSave(num, function (save_data) {
                ...
                j_slot
                  ...
                  .html(dateFormatter(save_data.save_date));
  ...
  snapSave: function (title, call_back, flag_thumb) {
    ...
    if ('false' == flag_thumb) {
      ...
      thumb_scale < 0.01 && (thumb_scale = 0.01);
  ...
  setHoverEvent: function (j_parent, options = {}) {
    if (
      -1 == j_parent.html().indexOf('$(".menu_item").hover') &&
      -1 == j_parent.html().indexOf('$(".menu_close").hover')
    )
      return !1;
  ...
  setMenuScrollEvents: function (j_parent, options = {}) {
    ...
    j_parent
      ...
      .click(() => {
        ...
        j_scroll_target.animate({ scrollTop: pos }, { queue: !1 });
      })
      .focusable();
    j_parent
  ...
  loadGameData: function (data, options) {
    ...
    if (this.kag.stat.cssload)
      for (let file in this.kag.stat.cssload) {
        ...
        'true' === this.kag.config.keyFocusWithHoverStyle &&
          j_style.on('load', () => {
    ...
    $('[data-restore]').each(function () {
      ...
      Array.isArray(restore_data) &&
        restore_data.forEach((item) => {
          const { tag: tag, pm: pm } = item;
          pm._next = !1;
  ...
  setMenu: function (j_obj, cb) {
    var layer_menu = this.kag.layer.getMenuLayer();
    this.setMenuCloseEvent(j_obj, { callback: cb });
    j_obj.hide();
  ...
  getSaveData: function () {
    ...
    tmp_array = new Array();
    var root = { kind: 'save', version: '2', hash: this.kag.save_key_val },
